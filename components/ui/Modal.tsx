...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, children, footer }) => {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-slate-900/40 dark:bg-slate-950/60 backdrop-blur-sm animate-fadeIn" onClick={onClose}>
      <div 
        className="bg-white dark:bg-slate-950 rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.08)] w-full max-w-2xl m-4 animate-scaleUp border border-slate-100 dark:border-slate-800/80 overflow-hidden" 
